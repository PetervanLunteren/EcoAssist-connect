...
# run script
python "${ECO_PATH}/cameratraps/megadetector/detection/run_detector_batch.py" "${ROOT_DIR}/models/megadetector/md_v5a.0.0.pt" "${IMG_DIR}" "${IMG_DIR}/image_recognition_file.json" --threshold "${DET_THRESH}" --output_relative_filenames --quiet
